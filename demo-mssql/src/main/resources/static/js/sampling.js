...
function QueryInitSetting() {
  ...
  // return;
	...
	$.ajax({
		type: "POST",
    url: G_MainRoot + '/test/initSampling',
		// dataType: "json",
...
function fake_querySampRouteFitPanelSize(action, isShow = false, sampOpListId = ""){
  //tttt = sampOpListId
  ...
  var dataList = [
    {panel_size: 'panel_size_1', route_id: 'route_id_1', route_ver: 'route_ver_1',description: 'desc_1'},
    {panel_size: 'panel_size_2', route_id: 'route_id_2', route_ver: 'route_ver_2',description: 'desc_2'}
  ];
  var noRouteArr = [
    {noRoute: 'noRoute_1'},
    {noRoute: 'noRoute_2'}
...
function querySampRouteFitPanelSize(action, isShow = false, sampOpListId = "") {
  fake_querySampRouteFitPanelSize(action, isShow, sampOpListId)
